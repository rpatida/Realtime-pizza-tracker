...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return initAdmin; });
...
function initAdmin(socket) {
  var orderTableBody = document.querySelectorAll("#orderTableBody");
  var orders = [];
  var markup;
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("/admin/orders", {
    ...
    orderTableBody[0].innerHTML = markup;
  })["catch"](function (err) {
    console.log("err", err);
  });
  ...
  socket.on("adminRoom", function (order) {
    ...
    orderTableBody[0].innerHTML = "";
    orderTableBody[0].innerHTML = generateMarkup(orders);
  });
}
...
var socket = io();
Object(_admin__WEBPACK_IMPORTED_MODULE_1__["default"])(socket); //join socket
...
__webpack_require__(/*! C:\Rajkumar\Node\Realtime-tracking\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Rajkumar\Node\Realtime-tracking\resources\scss\app.scss */"./resources/scss/app.scss");
